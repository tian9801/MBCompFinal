...
//    floatHelper(compressor.attack, Names::Attack_Mid_Band);
//    floatHelper(compressor.release, Names::Release_Mid_Band);
//    floatHelper(compressor.threshold,  Names::Threshold_Mid_Band);
//
//    floatHelper(compressor.attack, Names::Attack_High_Band);
//    floatHelper(compressor.release, Names::Release_High_Band);
//    floatHelper(compressor.threshold, Names::Threshold_High_Band);
...
void MBCompAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    buffer.clear();
    //each channel of filter buffer needs to be copied back
